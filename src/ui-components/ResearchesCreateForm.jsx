...
import { createResearches } from "../graphql/mutations";
const client = generateClient();
export default function ResearchesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setLatest_update_date(initialValues.latest_update_date);
    setAuthors(initialValues.authors);
    setInstitutions(initialValues.institutions);
    setAbstraction(initialValues.abstraction);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createResearches.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ResearchesCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
