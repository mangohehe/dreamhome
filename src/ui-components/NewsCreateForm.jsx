...
export default function NewsCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPublish_date(initialValues.publish_date);
    ...
    setTranslatedTitle(initialValues.translatedTitle);
    setTranslatedSummary(initialValues.translatedSummary);
    setErrors({});
  };
  const validations = {
    title: [{ type: "Required" }],
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createNews.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
