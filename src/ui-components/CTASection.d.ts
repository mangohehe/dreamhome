...
export declare type CTASectionOverridesProps = {
    ...
    "Today\u2019s News"?: PrimitiveOverrideProps<TextProps>;
    "Stay in touch and never miss an update"?: PrimitiveOverrideProps<TextProps>;
    "Keep up to date on the latest and greatest in the semiconductor industry"?: PrimitiveOverrideProps<TextProps>;
